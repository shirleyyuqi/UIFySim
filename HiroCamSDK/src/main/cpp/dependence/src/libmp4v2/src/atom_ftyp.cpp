...
#else
    majorBrand.SetValue( "isom" );
    minorVersion.SetValue( 512 );
    
    compatibleBrands.SetCount( 4 );
    compatibleBrands.SetValue( "isom", 0 );
    compatibleBrands.SetValue( "iso2", 1 );
    compatibleBrands.SetValue( "avc1", 2 );
    compatibleBrands.SetValue( "mp41", 3 );
#endif
}
