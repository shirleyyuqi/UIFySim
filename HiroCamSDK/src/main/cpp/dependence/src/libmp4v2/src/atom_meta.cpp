...
void MP4DataAtom::Generate()
{
    MP4Atom::Generate();
    typeReserved.SetValue(0);
    typeSetIdentifier.SetValue(0);
    typeCode.SetValue(itmf::BT_UTF8);
    locale.SetValue(0);
    metadata.SetValue((const uint8_t *)"Lavf55.48.100", 13);
