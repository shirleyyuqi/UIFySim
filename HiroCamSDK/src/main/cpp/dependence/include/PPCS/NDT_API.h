...
INT32 NDT_PPCS_Initialize(const CHAR *InitString, const UINT16 PortNo, const CHAR *DID, const CHAR *AES128Key);
void  NDT_PPCS_DeInitialize();
...
INT32 NDT_PPCS_SendTo(const CHAR *DIDString, const CHAR *Data, const UINT16 Size, const INT32 Mode);
INT32 NDT_PPCS_SendToByServer(const CHAR *DIDString, const CHAR *Data, const UINT16 Size, const INT32 Mode, const CHAR *InitString,const CHAR *AES128Key);
